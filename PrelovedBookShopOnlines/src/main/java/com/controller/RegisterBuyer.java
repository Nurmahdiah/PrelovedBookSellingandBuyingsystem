	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(registerbuyer.equals("SUCCESSFULLY REGISTER AS BUYER")) {
                ...
                RequestDispatcher requestdispatcher = request.getRequestDispatcher("buyerRegister.jsp");
            ...
            Logger.getLogger(RegisterBuyer.class.getName()).log(Level.SEVERE, null, ex);
      }
	}
