...
/**
 * Servlet implementation class UpdateProfileSeller
 */
@WebServlet("/UpdateProfileSeller")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("update") != null) {
			...
			try {
				...
				String updateprofile = profileaccountdb.sellerAccountUpdate(registermodel);
				
				if(updateprofile.equals("Profile Account Update Success")) {
					request.setAttribute("UpdateSuccessMsg", updateprofile);
					RequestDispatcher requestdispatcher = request.getRequestDispatcher("sellerAccount.jsp");
					requestdispatcher.forward(request, response);
				}
				else {
					request.setAttribute("UpdateErrorMsg", updateprofile);
	                RequestDispatcher requestdispatcher = request.getRequestDispatcher("sellerAccountUpdate.jsp");
