...
<head>
    ...
    <title>Buyer Profile Account</title>
...
<div class="container">
<h4><a href="homePage.jsp">Buyer</a> / Profile Account</h4>
<br>
...
<div class="card h-100">
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				<div class="user-avatar">
					<img src="customer.jpg" alt="Maxwell Admin">
				</div>
					<%
	 ...
	 try{
		 ...
		 preparedstatement = connection.prepareStatement("SELECT * FROM Buyer WHERE emailAddress='"+session.getAttribute("buyerLogin")+"'");
	...
	%>
				...
				<h6 class="user-email"><%=session.getAttribute("buyerLogin")%></h6>
			</div>
		</div>
	</div>
</div>
	...
	<div class="card-body">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="firstname" name="firstname" value="<%=resultset.getString("firstName") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="lastname">Last Name</label>
					<input type="text" class="form-control" id="lastname" name="lastname" value="<%=resultset.getString("lastName") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="username">Username</label>
					<input type="text" class="form-control" id="username" name="username" value="<%=resultset.getString("username") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phoneno" name="phoneno" value="<%=resultset.getString("phoneNo") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="street" name="street" value="<%=resultset.getString("street") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="city">City</label>
					<input type="text" class="form-control" id="city" name="city" value="<%=resultset.getString("city") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="postcode">Postcode</label>
					<input type="text" class="form-control" id="postcode" name="postcode" value="<%=resultset.getString("postcode") %>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="state">State</label>
					<input type="text" class="form-control" id="state" name="state" value="<%=resultset.getString("state") %>" readonly>
				</div>
			</div>
		</div>
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
					<!-- <a href="buyerAccountDelete.jsp?email=<%=session.getAttribute("buyerLogin")%>"><button type="button" id="submit" name="delete" class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete Account ? All your data will be deleted')">Delete Account</button></a> -->
					<a href="buyerAccountUpdate.jsp?email=<%=session.getAttribute("buyerLogin")%>"><button type="button" id="submit" name="update" class="btn btn-primary">Update</button></a>
				</div>
			</div>
		</div>
