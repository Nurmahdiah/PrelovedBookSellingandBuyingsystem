		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								<h2>Hello Buyer ! <br>Welcome to Login</h2>
								<p>Don't have an account?</p>
								<a href="buyerRegisterBuyBook.jsp?id=<%=bookid%>" class="btn btn-white btn-outline-white">Sign Up</a>
							</div>
			      </div>
					...
					<form action="LoginControllerBuyerBuyBook" class="signin-form" method="post">
		            ...
		            <div class="form-group d-md-flex">
									<div class="text-md-right">
										Forget Password ? <a style="text-decoration:underline;"  href="sendEmailBuyer.jsp"> Reset Password</a>
									</div>
		            </div>
		          </form>
