...
<header class="w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:448px">
 </div>
</header>
...
<div class="card h-100">
	...
	<%	
	 ...
	 try{
		 ...
		 preparedstatement = connection.prepareStatement("SELECT * FROM Orders WHERE sellerEmailAddress='"+session.getAttribute("sellerLogin")+"' AND orderId='"+session.getAttribute("orderId")+"' ");
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="title" value="wait" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="price">Price per Unit (RM)</label>
					<input type="text" class="form-control" id="price" value="wait" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
	...
	%>
	 ...
	 try{
		 ...
		 preparedstatement2 = connection2.prepareStatement("SELECT * FROM Shipment WHERE orderId='"+orderid+"'");
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-center">
					&nbsp; &nbsp; &nbsp;<a href="bookOrders.jsp"><button type="button" id="submit" name="submit" class="btn btn-secondary">Back to Order List</button></a>
				</div>
			</div>
		</div>
	</div>
