        ...
        <div class="col-md-8 order-md-1">
            ...
            <hr class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="tooltip">Hover to Pay
					  <span class="tooltiptext">Shipping Fee <br>Book Quantity <br>Semenanjung <br> 1 to 3 : RM 4.00 <br> 4 to 9 : RM 5.00 <br> 10 and above : RM 6.00</span>
					</div>
                </div>
                </div>
                <div class="row">
