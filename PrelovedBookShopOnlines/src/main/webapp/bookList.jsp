...
<%
	...
	%>
<body style="background-color:#ECE9D9;">
 
  <!-- Product grid -->
  <div class="w3-row w3">
    <div style="padding-top:60px;" class="w3-container w3-text" id="book">
    <br><h4>List of Preloved Books</h4><br>
  </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="viewImage.jsp" width="400px">
          <div class="w3-display-middle w3-display-hover">
            <a href="bookDetails.jsp?Id?"><button class="w3-button w3-black">Details</button></a>
          </div>
        </div>
        <p><%=resultset.getString("bookTitle") %><br><b><%=resultset.getString("price") %></b></p>
      </div>
    </div>
    	    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="beginend.jpg">
          <div class="w3-display-middle w3-display-hover">
            <a href="bookDetails.jsp"><button class="w3-button w3-black">Details</button></a>
          </div>
        </div>
        <p>We Begin at the End<br><b>RM 10.00</b></p>
      </div>
    </div>	
	<%	
		 } 
  ...
  <div class="w3-row">
    <div style="padding:60px 20px;" class="w3-container w3-text-grey">  
  	<a href="addbook.jsp"><button class="w3-button w3-black" type="button">Add Preloved Book<i class="fa fa-update"></i></button></a>
  </div>
  </div>
<script>
// Modal Image Gallery
