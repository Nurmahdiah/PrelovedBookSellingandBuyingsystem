    ...
    <div class="page-wrapper bg-dark p-t-100 p-b-50">
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
			    ...
			    %>
                    <form name="register" action="RegisterBuyerBuyBook" method="post">
                        <div class="form-row">
                 ...
                 <div class="card-footer">
                    ...
                    <a href="buyerLoginBuyBook.jsp"><button type="button" class="btn btn--radius-2 btn--blue-2">Cancel</button></a>
                </div>             
                    </form>
                </div>
            </div>
