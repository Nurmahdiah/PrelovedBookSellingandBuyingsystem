...
<body style="background-color:#ECE9D9;">
 ...
 <%
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="viewImage.jsp?id=<%=resultset.getString("Id")%>" width="400px">
          <div class="w3-display-middle w3-display-hover">
            <a href="bookDetails.jsp?id=<%=resultset.getString("Id")%>"><button type="submit" id="submit" name="submit" class="w3-button w3-black">Details</button></a>
          </div>
        </div>
        <p><%=resultset.getString("bookTitle") %><br><b><%=resultset.getDouble("price") %></b></p>
  ...
  <div class="w3-row">
    <div style="padding:160px 20px;" class="w3-container w3-text-grey">  
