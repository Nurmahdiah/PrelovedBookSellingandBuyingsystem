...
<div class="container">
<h4> <a href="homePage.jsp">Buyer</a> / <a href="buyerAccount.jsp">Profile Account </a>/ Update Profile Account</h4>
<br>
	...
	<div class="card-body">
	 ...
	 if(request.getParameter("email") != null)
	 {
		 ...
		 try
		 {
			 ...
			 preparedstatement = connection.prepareStatement("SELECT * FROM Buyer WHERE emailAddress=?");
...
<div class="card h-100">
	<div class="card-body">
	<form action="UpdateProfileBuyer" method="post" id="buyerAccount" onsubmit="return validate();">
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
					<a href="buyerAccount.jsp"><button type="button" id="submit" name="cancel" class="btn btn-secondary">Cancel</button></a>
