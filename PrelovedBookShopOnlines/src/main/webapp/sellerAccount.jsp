...
<div class="container">
<h4><a href="newShop.jsp">Seller</a> / Profile Account</h4>
<br>
...
<div class="card h-100">
	<div class="card-body">
	 ...
	 try{
		 ...
		 preparedstatement = connection.prepareStatement("SELECT * FROM Seller WHERE emailAddress='"+session.getAttribute("sellerLogin")+"'");
	...
	<div class="card-body">
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<!-- 	<a href="sellerAccountDelete.jsp?email=<%=session.getAttribute("sellerLogin")%>"><button type="button" id="submit" name="cancel" class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete Account ? All your Data will be deleted')">Delete Account</button></a>  -->
					<a href="sellerAccountUpdate.jsp?email=<%=session.getAttribute("sellerLogin")%>"><button type="button" id="submit" name="update" class="btn btn-primary">Update</button></a>
				</div>
			</div>
		</div>
		<%	
