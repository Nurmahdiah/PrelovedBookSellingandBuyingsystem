...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script> <!-- script to control button -->
<style>
  ...
  <a class="w3-bar-item w3-button" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   String orderid = request.getParameter("orderid");
	 ...
	 try{
		 ...
		 //WHERE Orders.sellerEmailAddress='"+session.getAttribute("sellerLogin")+"' AND
		
		
		 preparedstatement = connection.prepareStatement("SELECT Orders.*, PrelovedBook.* FROM Orders INNER JOIN PrelovedBook ON Orders.bookId=PrelovedBook.Id WHERE Orders.orderId='"+orderid+"' OR Orders.orderId='"+request.getAttribute("orderIdNo")+"'");

		//	 preparedstatement = connection.prepareStatement("SELECT Orders.*, PrelovedBook.* FROM Orders INNER JOIN PrelovedBook ON Orders.bookId=PrelovedBook.Id WHERE Orders.orderId='"+session.getAttribute("ShipmentorderId")+"' ");
...
<div class="container">
<h4><a href="newShop.jsp">Seller</a> / <a href="bookOrders.jsp"> Preloved Book Order List  </a>/ OD001 Order Details </h4>
<br>
<div class="row gutters">
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
<div class="card h-100">
	<div class="card-body">
	<form action="bookOrderIIAdd.jsp" name="disForm">
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="orderId" value="<%=resultset.getString("orderId")%>" readonly>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="buyerId" value="<%=resultset.getString("buyerEmailAddress")%>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
	 ...
	 try{
		 ...
		 preparedstatement2 = connection2.prepareStatement("SELECT * FROM Shipment WHERE orderId='"+orderid2+"' OR orderId='"+request.getAttribute("orderIdNo")+"' ");
		 //sellerEmailAddress='"+session.getAttribute("sellerLogin")+"' AND 
	...
	%>
		<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control"  id="shipNo" name="shipNo" value="<%=resultset2.getString("ShippingNo")%>"  readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="shipStatus">Shipping Status</label>
					<input type="text" class="form-control"  id="shipStatus" name="shipStatus" value="<%=resultset2.getString("shippingStatus")%>"  readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="postcode">Shipping Date</label>
					<input type="date" class="form-control"  id="shippingDate" name="shippingDate" value="<%=resultset2.getString("shippingDate")%>"  readonly>
				</div>
			</div>
		</div>
		<%	
   ...
   <br><br>
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<input type="hidden" id="orderid" name="id" value="<%=resultset.getString("orderId")%>" readonly>
 &nbsp; &nbsp;  <button type="submit" id="submit-button" onclick="disableFunction()" name="submit-button" class="btn btn-primary" >Add Shipment Details</button> 
                <a href="bookOrderIIUpdate.jsp?id=<%=resultset.getString("orderId")%>"><button type="button" id="update-button" name="update" class="btn btn-primary" >Update Shipment Details</button></a>
				<a href="bookOrders.jsp"><button type="button" id="submit" name="submit" class="btn btn-secondary">Back</button></a>
				</div>
			</div>
		</div>
	</form></div>
...
function disableFunction(){
	...
	if (x != ''){
		...
		alert("Only 1 Shipment Details for One order")
	}
	else if (x == ''){
