        ...
        <div class="col-md-8 order-md-1">
            ...
            <hr class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="shippingfee" name="shippingfee"  value="<%=request.getAttribute("shippingsabah")%>" readonly >
                </div>
                </div>
                <div class="row">
                <div class="mb-4">
                        <label for="totalfee">Total</label>
                        <input type="text" class="form-control" id="totalfee" name="totalfee" value="<%=request.getAttribute("totalsabah")%>" readonly>
                </div>  
                </div>
