                    ...
                    <tr>
                       ...
                       <input type="hidden" name="bookid" id="bookid" value="<%=resultset.getString("Id")%>">
                        ...
                        <div class="text-center">
                                <a href="buyerCartDelete.jsp?idorder=<%=resultset.getString("orderId")%>"><button type="button" name="delete" id="delete" class="btn btn-white border-secondary bg-white btn-md mb-2"><i class="fa fa-trash"></i></button></a>
                        		<div style="padding-bottom:8px;"><button  type="submit" name="update" id="update" class="btn btn-primary"><i class="fa fa-save"></i></button> </div>
