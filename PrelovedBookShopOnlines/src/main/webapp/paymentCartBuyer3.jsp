...
<br>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <hr class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="shippingfee" name="shippingfee"  value="<%=request.getAttribute("shippingsarawak")%>" readonly >
                </div>
                </div>
                <div class="row">
                <div class="mb-4">
                        <label for="totalfee">Total</label>
                        <input type="text" class="form-control" id="totalfee" name="totalfee" value="<%=request.getAttribute("totalsarawak")%>" readonly>
                </div>  
                </div>
	...
	%>
             <a href="cart.jsp"><button class="btn btn-secondary" type="submit" name="cancel" id="cancel">Cancel</button></a>
     <%	
		 } 
