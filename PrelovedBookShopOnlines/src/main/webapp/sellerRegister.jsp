        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">One Step Ahead to Start Your Online Preloved Book Shop</h2>
                </div>
                <div class="card-body">
                ...
                <div id="message">
                    ...
                    <form name="register" action="RegisterSeller" method="POST" id="sellerRegister">
                        <div class="form-row">
                 ...
                 <div class="card-footer">
                    ...
                    <a href="sellerLogin.jsp"><button class="btn btn--radius-2 btn--blue-2" type="button">Cancel</button></a>
                </div>          
                    </form>
                </div>
            </div>
