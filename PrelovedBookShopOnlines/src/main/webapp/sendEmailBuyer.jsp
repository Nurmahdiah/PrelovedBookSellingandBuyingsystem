				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div id=emailpatt>
			      		...
			      		<input type="hidden" id="message" name="message" value="Hello Buyer ! Your are receiving this message because you choose to reset your Password on the Preloved Book Shop Platform . Go on to this link to reset your password.  http://localhost:8080/PrelovedBookOnline/buyerforgetPassword.jsp  Thank You.">
			      		
		            <div>
		            	<button type="submit" name="reset" onclick="callJqueryAjax()" class="form-control btn btn-primary">Reset Password</button>
		            </div>
		            <br><br>
		          <a href="buyerLogin.jsp"><i class="fa fa-arrow-left"> Back</i></a>
		        </div>
		      </div>
				</div>
			</div>
