...
<div class="container">
<h4><a href="newShop.jsp">List of Preloved Book</a> / Book Details</h4>
<br>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="price" name="price" value="<%=resultset.getString("price")%>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="stock">Stock</label>
					<input type="number" class="form-control" id="stock" name="stock" value="<%=resultset.getString("stock")%>" readonly>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="bookCond">Book Condition</label>
					<input type="text" class="form-control" readonly value="<%=resultset.getString("bookCondition")%>"/>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="price">Status</label>
					<input type="text" class="form-control" readonly value="<%=resultset.getString("status")%>"/>
				</div>
			</div>
			  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="genre">Genre of Book</label>
				 <input type="text" class="form-control" readonly value="<%=resultset.getString("bookGenre")%>" >
				</div>
			</div>
		</div>
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
					<a href="updateBook.jsp?id=<%=bookid%>"><button type="button" id="update" name="update" class="btn btn-primary">Update</button></a>
					<a href="deleteBook.jsp?id=<%=bookid%>"><button type="button" id="remove" name="remove" class="btn btn-danger" onclick="return confirm('Are you sure you want to Remove the  Preloved Book  ?')">Remove</button></a>
					<a href="newShop.jsp"><button type="button" id="cancel" name="cancel" class="btn btn-secondary">Cancel</button></a>
				</div>
			</div>
		</div>
	</div>
