...
<div class="card h-100">
	<div class="card-body">
	<form action="sellerOrderShipmentAdd" method="post" onsubmit="myDate()">
	   <%
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control"  list="statusList" id="shipStatus" name="shipStatus" >			    
	...
	%>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="postcode">Shipping Date</label><%=strDate%>
					<input type="date" class="form-control" id="shipDate" name="shipDate" min="<%=strDate%>">
				</div>
			</div>
		</div>
...
function myDate() {
  var x = document.getElementById("shipDate").min;
}
