  ...
  <div  style="padding-top:91px; padding-bottom:348px;" class="container">
    <div class="row w-100">
        <div class="col-lg-12 col-md-12 col-12">
            <h4 class="display-5 mb-2 text-left"><a href="homePage.jsp">Buyer</a> / Shopping Cart Payment </h4>
            <br>
            <form action="buyerCartPay" method="post">
	 ...
	 try{
		 ...
		 preparedstatement = connection.prepareStatement("SELECT Orders.*, PrelovedBook.* FROM Orders INNER JOIN PrelovedBook ON Orders.bookId=PrelovedBook.Id WHERE Orders.buyerEmailAddress='"+session.getAttribute("buyerLogin")+"' AND Orders.status='cartunpaid' AND Orders.orderId='"+idorder+"'");
	...
	%>
                <tbody>
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="dateorder" id="dateorder" value="<%=resultset.getString("date")%>">
						<input type="hidden" name="defaultstatus" id="defaultstatus" value="<%=resultset.getString("status")%>">
						<input type="hidden" name="buyerid" id="buyerid" value="<%=resultset.getString("buyerEmailAddress")%>">
						<input type="hidden" name="selleremail" id="selleremail" value="<%=resultset.getString("sellerEmailAddress")%>">
						...
						<input type="hidden" name="quantity" id="quantity" value="<%=resultset.getString("quantity")%>">
                        ...
                        <div class="text-center">
                           <div style="padding-bottom:8px;"><button  type="submit" name="pay" id="pay" class="btn btn-danger">Confirm to Pay</button> </div>
