...
<div class="card h-100">
	...
	<form action="buyerOrderPay" method="post">
	<h6 class="mb-2 text-primary">Purchase Now</h6>
	
	<label>Quantity</label>
	
	<input class="form-control" type="number" name="quantity" id ="bookQuantity">
	...
	Date date = new Date();
	%>
	<input type="hidden" name="dateorder" id="datepicker" value="<%=date.toString()%>">
	...
	<input type="hidden" name="sellerid" id="sellerid" value="<%=resultset.getString("sellerEmail")%>">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-center">
					<button type="submit" id="submit" name="submit" class="btn btn-primary">Pay Now</button>
					
					<a href="purchaseList.jsp"><button type="button" id="submit" name="submit" class="btn btn-secondary">Cancel</button></a>
				</div>
			</div>
		</div>
	</form>
